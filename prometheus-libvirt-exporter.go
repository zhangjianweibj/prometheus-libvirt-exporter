...
var (
	...
	libvirtDomainState = prometheus.NewDesc(
		...
		[]string{"domain", "instanceName", "instanceId", "userName", "userId", "projectName", "projectId", "host", "stateDesc"},
		nil)
	...
	libvirtDomainBlockRdBytesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "instanceName", "instanceId", "userName", "userId", "projectName", "projectId", "host", "source_file", "target_device"},
		nil)
	...
	libvirtDomainInterfaceRxBytesDesc = prometheus.NewDesc(
		...
		[]string{"domain", "instanceName", "instanceId", "userName", "userId", "projectName", "projectId", "host", "source_bridge", "target_device"},
		nil)
