...
domain_block_info_capacity|"domain", "instanceName", "instanceId", "flavorName", "userName", "userId", "projectName", "projectId", "host", "source_file", "source_rbd", "source_ceph_mon_host", "target_device"|How much storage the guest will see, in bytes
domain_block_info_allocation|"domain", "instanceName", "instanceId", "flavorName", "userName", "userId", "projectName", "projectId", "host", "source_file", "source_rbd", "source_ceph_mon_host", "target_device"|Host storage in bytes occupied by the image, in bytes
domain_block_info_physical|"domain", "instanceName", "instanceId", "flavorName", "userName", "userId", "projectName", "projectId", "host", "source_file", "source_rbd", "source_ceph_mon_host", "target_device"|Host physical size in bytes of the image container, in bytes
